# UI Foundry Spacer Studio

Standalone visual Spacer generator built with Next.js, React, and TypeScript.

Standalone Spacer component studio for building native, preview-honest, React-exportable UI patterns that match the UI Foundry product line.
...
- designers building Spacer UI quickly
- developers who need editable React starting points
- marketplace buyers who want a self-contained Spacer generator
...
The editor is focused on controls that are native to Spacer and useful in real product work:
- block/inline spacing, size scale, responsive spacing, divider-like empty space, and layout rhythm
- semantic decorative-only behavior and hidden accessibility impact
- debug preview, guide color, and spacing token naming
- container-safe export without fake content
- React export for spacing utility

The goal is maximum useful depth without adding unrelated controls that would make the component stop reading as Spacer.
...
This repo is intended to publish as Abid-Al-Hossain/UI_spacer.
