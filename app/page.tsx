...
const nativeFeatures = [
  "Responsive size: max width, min height, breakpoint behavior, safe spacing tokens",
  "Composition: slots, landmarks, sticky/fixed behavior where native, content density",
  "Alignment: flex/grid placement, gap, inset, order, wrap, and visual rhythm",
  "Accessibility: semantic element, landmark label, reduced motion, readable contrast"
] as const;

const defaultState: StudioState = {
  title: "Spacer Studio",
  description: "Native spacer pattern with preview/export-honest controls.",
  label: "Spacer",
  value: "spacer",
...
const presets: Preset[] = [
  { family: "layout", archetype: "SaaS", variant: "glass", size: "balanced", tags: ["premium", "dark", "export-safe"], state: defaultState },
  { family: "layout", archetype: "Editorial", variant: "soft", size: "spacious", tags: ["marketplace", "content"], state: { ...defaultState, density: "spacious", background: "#f8fafc", foreground: "#0f172a", border: "#cbd5e1", accent: "#f59e0b", shadow: 10 } },
  { family: "layout", archetype: "Admin", variant: "crisp", size: "compact", tags: ["dashboard", "dense"], state: { ...defaultState, density: "compact", radius: 10, width: 320, height: 140, gap: 8, fontSize: 14, accent: "#22c55e" } },
  { family: "layout", archetype: "Commerce", variant: "hero", size: "spacious", tags: ["commerce", "bold"], state: { ...defaultState, title: "Conversion Spacer", accent: "#fb7185", background: "#1e1b4b", width: 420, height: 220, shadow: 36 } },
];
...
export default function Page() {
  ...
  const [downloadName, setDownloadName] = useState("spacer-component");
    ...
    <main className="mx-auto grid min-h-screen max-w-[1500px] gap-6 px-5 py-6 lg:grid-cols-[430px_1fr]">
      <aside className="space-y-5">
        <header className="rounded-[2rem] border border-white/10 bg-slate-950/70 p-5 shadow-2xl shadow-black/30">
          ...
          <h1 className="mt-3 text-3xl font-black tracking-tight">Spacer Studio</h1>
          <p className="mt-2 text-sm text-slate-400">Self-contained, React-only, buyer-ready spacer generator.</p>
        </header>
